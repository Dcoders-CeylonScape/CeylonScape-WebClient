...
<div className="relative">
  <div className="w-full">
    <img src={BackgroundImage} className="h-full w-full object-cover sm:h-[50vh] md:h-[60vh] lg:h-[70vh] xl:h-[80vh] 2xl:h-[100vh]" alt="" />
  </div>

  <div className="absolute bottom-[30px] w-full flex flex-col items-center p-4">
    <div className="text-white text-[90px] font-semibold text-2xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-[90px]" style={{
      textShadow: "0 0 10px rgba(0, 0, 0, 1)",
    }}>Explore the Wonders of</div>
    <div className="text-white font-semibold text-4xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl 2xl:text-[200px]" style={{
      textShadow: "0 0 10px rgba(0, 0, 0, 1)",
      marginBottom: "-10px",
    }}>Sri Lanka</div>
  </div>
            ...
            <div className="flex flex-col items-center">
                <div className="text-2xl font-medium my-10 sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-[40px]">Top Attractions</div>
            ...
            <div className="flex flex-col items-center mt-10">
                <div className="text-2xl font-medium text-center my-10 sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-[40px]">Top Experience the Rich Culture of Sri Lanka</div>
            ...
            <div className="flex flex-col items-center mt-10">
                <div className="text-2xl font-medium my-10 sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-[40px]">What's New</div>
